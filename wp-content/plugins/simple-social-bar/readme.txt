...
= 1.0.2 =
Bug fix: fixed problem with URL specificity for Facebook like buttons that was only being applied to the large button like buttons and not the in-line small like buttons. 
