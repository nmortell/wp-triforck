...
?>
    ...
    document.getElementsByTagName('head')[0].appendChild(e);
      ...
      function show_link( $content = false ) {
        ...
        $button = apply_filters( 'instaemail_button', '<div class="instaemail'.$align.'"><a class="instaemail" href="'.$href.'" rel="nofollow" title="Email this page" '.$onclick.'>'.$this->button().'</a></div>' );
      ...
      function button( $name = false ){
        ...
        case "text-only":
          ...
          break;
        default:
          return '<img src="'.$img_path.$name.'" alt="Email This Page" />';
          break;
        }
      }
      ...
      <!--Section 2 Button Placement-->
        ...
        <span id="css"><input type="checkbox" name="<?php echo $this->option_name; ?>[enable_css]" value="<?php $this->val('enable_css');?>" <?php $this->checked('enable_css', 'no'); ?> />Do not use CSS for button styles</span>
              ...
              <div id="pages">
                ...
                <label><?php _e( "Use [email_this_button] inside your page/article or put the following code in your template:", $this->hook ); ?></label>
                <textarea  id="pf-shortcode" class="code" rows="3" cols="50">&lt;?php if(function_exists('instaemail_show_link')){echo instaemail_show_link();} ?&gt;</textarea>
              </div>
            </div>
          <br class="clear">
          <p class="submit">
