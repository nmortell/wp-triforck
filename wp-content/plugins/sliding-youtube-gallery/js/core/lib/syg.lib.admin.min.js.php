...
$root = realpath(dirname(dirname(dirname(dirname(dirname(dirname(dirname($_SERVER["SCRIPT_FILENAME"]))))))));
...
$target_dir = SYG_PATH . SygConstant::WP_CACHE_JS_REL_DIR . DIRECTORY_SEPARATOR;
...
$name = 'syg.lib.admin.min.js-' . SygUtil::folder2Md5('./');
...
if(file_exists($target_dir.$name)) {
	...
	// generate files
	$js .= file_get_contents(SYG_URL . 'js/core/lib/syg.lib.admin.js.php?id='.$id);
	...
	if(isset($_REQUEST['minify'])) {
		...
		$js.="setTimeout(function(){var a=document.createElement('img');a.src='" . SYG_URL . "js/core/lib/syg.lib.admin.min.js.php?minify=1';a.style.display='none';document.body.appendChild(a);},5000);";
	}
	echo $js;
}
?>