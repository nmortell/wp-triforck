...
//2.1 changes end	
		...
		$smooth_slide_image=apply_filters('smooth_slide_image',$smooth_slide_image,$post_id,$smooth_slider,$smooth_slider_css);
	        $html .= '<div class="smooth_slide_img">';	
		...
		if ($smooth_slider['image_only'] == '1') { 
		   ...
		   if($permalink!='') {
			$html .= '<div class="smooth_slide_content"><h2 '.$smooth_slider_css['smooth_slider_h2'].'><a '.$smooth_slider_css['smooth_slider_h2_a'].' href="'.$permalink.'">'.$post_title.'</a></h2><div '.$smooth_slider_css['smooth_slider_span'].'> '.$slider_excerpt.'</div>
				<p class="smooth_more"><a href="'.$permalink.'" '.$smooth_slider_css['smooth_slider_p_more'].'>'.$smooth_slider['more'].'</a></p></div>
			
				<!-- /smooth_slideri -->
			</div>'; }
		   else{
		   $html .= '<div class="smooth_slide_content"><h2 '.$smooth_slider_css['smooth_slider_h2'].'>'.$post_title.'</h2><div '.$smooth_slider_css['smooth_slider_span'].'> '.$slider_excerpt.'</div></div>
				<!-- /smooth_slideri -->
			</div>';    }
		}
	}
