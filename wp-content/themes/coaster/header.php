...
<div id="wrap">
	...
	<div id="header">
		<div id="logo">
		<?php
			$options = get_option('coaster_theme_options_logo');
			if ($options != "") {
		?>
		...
		<?php wp_nav_menu(array('theme_location' => 'coaster_nav', 'menu' => 'coaster_nav')); ?>
	...
	<div id="banner">
		<?php
			...
			if ($options['coaster_main_punchline'] != "") echo "<div id=\"banner-headline\">".str_replace("\\", "", $options['coaster_main_punchline'])."</div>";
			if ($options['coaster_headline'] != "") echo "<div id=\"banner-secondary\">".str_replace("\\", "", $options['coaster_headline'])."</div>";
		?>
	</div>
